 ...
 * publish content?" — not a mechanism. Checks are keyed by fully-qualified
 * case reference (`$ability::class . '::' . $ability->name`), so a backed
 * enum is not required — \BackedEnum extends \UnitEnum, so one is still
 * permitted for a consumer who wants one for other reasons.
 *
